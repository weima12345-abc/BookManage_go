...
func AddOrderItem(orderItem *model.OrderItem_chenjunjie) error {
	//写sql语句
...
func GetOrderItemsByOrderID(orderID string) ([]*model.OrderItem_chenjunjie, error) {
	//写sql语句
	...
	var orderItems []*model.OrderItem_chenjunjie
	for rows.Next() {
		orderItem := &model.OrderItem_chenjunjie{}
