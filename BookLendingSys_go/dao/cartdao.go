...
//AddCart 向购物车表中插入购物车
func AddCart(cart *model.Cart_chenjunjie) error {
	//写sql语句
...
func UpdateCart(cart *model.Cart_chenjunjie) error {
	//写sql语句
