...
//Cart 购物车结构体
type Cart_chenjunjie struct {
	CartID      string      //购物车的id
	CartItems   []*CartItem_chenjunjie //购物车中所有的购物项
...
func (cart *Cart_chenjunjie) GetTotalCount() int64 {
...
func (cart *Cart_chenjunjie) GetTotalAmount() float64 {
